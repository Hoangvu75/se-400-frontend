...
} from '@react-monorepo/components';
import { registerText } from './styles';

const LoginPage = () => {
  return (
    <div style={Styles.pageStyle}>
      <NavBar showSignButtons={false} />
      <div style={Styles.pageBody}>
          ...
          <div style={Styles.loginForm}>
            ...
            <form>
              ...
              <div style={Styles.inputContainer}>
                ...
                <LinkText href="#" style={Styles.forgotPassword}>
                  Quên mật khẩu
                </LinkText>
              </div>

              <CommonButton style={Styles.loginButton} type="submit">
                Đăng nhập
              </CommonButton>

              <div>
                <p style={Styles.loginTitle}>Hoặc đăng nhập bằng</p>
                <OtherTypeLoginButtons />
              </div>
              ...
              <p style={Styles.signUpText}>
                ...
                <LinkText style={registerText} href="/register">
                  Đăng ký ngay
                </LinkText>
              </p>
            </form>
        ...
        <div style={Styles.appSlogan}>
          <div>
            ...
            <h1 style={Styles.appSloganTitle}>
              Ứng dụng tìm việc làm hàng đầu
            </h1>
            <p style={Styles.appSloganSubtitle}>
              Đăng nhập ngay để tìm kiếm công việc mơ ước
            </p>
          </div>
        </div>
      </div>
